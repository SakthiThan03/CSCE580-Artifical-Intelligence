...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        # State representation: (position, corners_visited_tuple)
        # corners_visited is a tuple of 4 booleans (True if corner has been visited)
        corners_visited = tuple([False, False, False, False])
...
def cornersHeuristic(state, problem):
    ...
    # Calculate maximum Manhattan distance from current position to any unvisited corner
    max_distance = 0
...
class AnyFoodSearchProblem(PositionSearchProblem):
    ...
    def isGoalState(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # Goal state is any position that has food
